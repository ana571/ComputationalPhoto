...
def crop_middle_half(image_path, output_path):
    ...
    middle_half = image.crop((quarter_point, 0, three_quarter_point, height))
...
def unwrap_and_cut_img(input_image_path, output_left_path, output_right_path, fov):
    ...
    unwrapped_left = project_image(left_path, left_final_path, fov)
    unwrapped_right = project_image(right_path, right_final_path, fov)
